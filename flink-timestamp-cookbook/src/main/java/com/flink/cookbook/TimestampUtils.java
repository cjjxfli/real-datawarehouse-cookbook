...
public class TimestampUtils {
    /**
     * 显示年月日星期时，例如 2022_08_237_23.
     */
    public static final String YYYY_MM_DD_HH = "YYYY_MM_DD_HH";
    /**
    ...
    public static String transDateToString(Timestamp date, String pattern) {
        String strTimestamp = "";
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, calendar.get(Calendar.HOUR_OF_DAY));
        SimpleDateFormat df = new SimpleDateFormat(pattern);
        strTimestamp = df.format(calendar.getTime());
     ...
     * @return String 日期时间字符串，例如 2015-08-11 09:51:53
     */
    public static String format(LocalDate temporal, String pattern) {
     ...
     * @return String 日期时间字符串，例如 2015-08-11 09:51:53
     */
    public static String format(LocalTime temporal, String pattern) {
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern(pattern);
        return dateTimeFormatter.format(temporal);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("========");
        System.out.println(parseLocalDateTime("2022-12-13 11:14:12", DATETIME_PATTERN));
        System.out.println(parseLocalDate("2022-12-13", DATE_PATTERN));
